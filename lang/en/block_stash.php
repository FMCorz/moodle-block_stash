...
$string['filterstashnotactive'] = 'We recommend that you use the <a href="{$a->installurl}">filter plugin for Stash</a>. Visit <a href="{$a->activeurl}" target="_blank">this page</a> to enable it for this course.';
$string['filterstashnotenabled'] = 'We recommend that you use the <a href="{$a->installurl}" target="_blank">filter plugin for Stash</a> for simpler snippets. It is installed but not <a href="{$a->enableurl}" target="_blank">enabled</a> yet.';
