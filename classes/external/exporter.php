...
// Requirements for core_competency\external\exporter copy/paste.
use stdClass;
use renderer_base;
use context;
use context_system;
...
if (!class_exists('core\\external\\persistent_exporter')) {
    ...
    if (!class_exists('core_competency\\external\\persistent_exporter')) {
        ...
        // Ensures that external_format_string exists.
        ...
        /**
         * Copy/paste from core_competency\external\exporter.
         */
         ...
         * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
         */
        class exporter extends \core_competency\external\exporter {
        }
     ...
     * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
     */
    class exporter extends \core\external\exporter {
    }
