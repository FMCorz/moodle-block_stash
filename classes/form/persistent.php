...
// Requirements for tool_lp\persistent copy/paste.
use coding_exception;
use moodleform;
use stdClass;

if (!class_exists('core\\form\\persistent')) {
    // At the moment we rely on tool_lp.
    // Add compability with < 3.1 where the class does not exist.
    if (!class_exists('tool_lp\\form\\persistent')) {

        require_once($CFG->libdir.'/formslib.php');

        /**
         * Copy/paste from tool_lp\form\persistent.
         */
