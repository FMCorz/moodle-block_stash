...
// Use requirements for core_competency\persistent copy/paste.
...
if (!class_exists('core\\persistent')) {
    // At the moment we rely on the competency API.
    // Add compability with < 3.1 where the class does not exist.
    if (!class_exists('core_competency\\persistent')) {
        ...
        // When persistent will be in core, not in a subsystem, we'll depend on it.
